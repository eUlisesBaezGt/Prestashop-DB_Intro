...
CREATE TABLE IF NOT EXISTS `PREFIX_cms_category_shop` (
`id_cms_category` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `PREFIX_configuration_kpi` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_configuration_kpi_lang` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_authorization_role` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_module_carrier` (
`id_module` INT(10) unsigned NOT NULL,
`id_shop` INT(11) unsigned NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `PREFIX_tag_count` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_smarty_lazy_cache` (
`template_hash` varchar(32) NOT NULL DEFAULT '',
`cache_id` varchar(191) NOT NULL DEFAULT '',
`compile_id` varchar(32) NOT NULL DEFAULT '',
`filepath` varchar(255) NOT NULL DEFAULT '',
`last_update` datetime NOT NULL , /*WO DEFAULT*/
PRIMARY KEY (
`template_hash`, `cache_id`, `compile_id`
)
)  ;

CREATE TABLE IF NOT EXISTS `PREFIX_smarty_last_flush` (
`type` ENUM('compile', 'template'),
`last_flush` datetime NOT NULL , /*WO DEFAULT*/
PRIMARY KEY (`type`)
)  ;
...
CREATE TABLE IF NOT EXISTS `PREFIX_employee_session` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_customer_session` (
